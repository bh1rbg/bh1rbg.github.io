...
<img src="{{site.baseurl}}/images/dh1718-face.jpg" class="center"  height="400px"/>
<!--more-->
...
<img src="{{site.baseurl}}/images/dh1718-internal.jpg" class="center" />

## 电压不准

这机器有点小毛病, 第一路电压不准. 经研究(瞎调整), 螺丝刀所指电位器控制能达到的最高电压, 向右数第四个控制指示准确度. 调下就好.

<img src="{{site.baseurl}}/images/dh1718-adjustment.jpg" class="center" />

## 限流电位器损坏

装好后发现, 电源指示灯线被我碰断, 不能忍, 就拆开焊上了. 再次组装, 限流电位器被我用力过猛, 拧坏了...  并且没有合适代换型号, 虽然有一抽屉的电位器.

<img src="{{site.baseurl}}/images/dh1718-wx13-12.jpg" class="center" />
...
<img src="{{site.baseurl}}/images/dh1718-sch.jpg" class="center" />
